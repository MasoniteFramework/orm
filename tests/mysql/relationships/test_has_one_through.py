...
class InboundShipment(Model):
    @has_one_through(
        None, "from_port_id", "country_id", "port_id", "country_id"
    )
...
class MySQLHasOneThroughRelationship(unittest.TestCase):
    ...
    def test_has_query(self):
        query_sql = InboundShipment.has("from_country").to_sql()
    ...
    def test_where_has_query(self):
        query_sql = InboundShipment.where_has(
    ...
    def test_doesnt_have(self):
        query_sql = InboundShipment.doesnt_have("from_country").to_sql()
    ...
    def test_has_one_through_with_count(self):
        query_sql = InboundShipment.with_count("from_country").to_sql()
