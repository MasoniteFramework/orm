    ...
    def test_can_advanced_table_creation(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                "`admin` INT(11) NOT NULL DEFAULT 0, `option` VARCHAR(255) NOT NULL DEFAULT 'ADMIN', `remember_token` VARCHAR(255) NULL, "
                "`verified_at` TIMESTAMP NULL, `registered_at` TIMESTAMP NOT NULL DEFAULT NOW(), "
