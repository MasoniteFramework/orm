    ...
    def test_can_advanced_table_creation(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                "`created_at` DATETIME NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT users_id2_primary PRIMARY KEY (id2), CONSTRAINT users_email_unique UNIQUE (email))"
            ],
        )
