...
class Store(Model):
    ...
    @belongs_to_many(None, "store_id", "product_id", "id", "id", with_timestamps=True)
    def products(self):
        return Product

    @belongs_to_many(None, "store_id", "product_id", "id", "id", table="product_store")
...
class SqliteTestRelationships(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        with cls.schema.create("product_store") as table:
            table.integer("id").primary()
    ...
    def setUp(self):
        ...
        self.dev_builder.table("users_rel").bulk_create(
            [
        ...
        self.dev_builder.table("profiles_rel").bulk_create(
            [
        ...
        self.dev_builder.table("Logos_rel").bulk_create(
            [
                {"name": "Bing"},
                {"name": "Zap"},
                {"name": "Swoosh"},
        ...
        self.dev_builder.table("articles_rel").bulk_create(
            [
                {
                    "user_id": 2,
        ...
        self.dev_builder.table("products").bulk_create(
            [
                {"name": "Pants"},
                {"name": "Shirt"},
                {"name": "Socks"},
        ...
        self.dev_builder.table("stores").bulk_create(
            [
                {"name": "K-Mart"},
                {"name": "Target"},
                {"name": "Costco"},
        ...
        self.dev_builder.table("product_store").bulk_create(
            [
    ...
    def test_associate_records(self):
        ...
        # TODO: fix HasMany Relationship - save does not work
