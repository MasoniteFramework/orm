...
class TestPostgresSchemaBuilderAlter(unittest.TestCase):
    ...
    def test_alter_drop_unique_constraint(self):
        ...
        expected_sql = [
            'ALTER TABLE "users" DROP CONSTRAINT users_playlist_id_unique'
        ]
    ...
    def test_alter_drop_index(self):
        ...
        expected_sql = ["DROP INDEX users_playlist_id_index"]
    ...
    def test_has_table(self):
        ...
        expected_sql = "SELECT * from information_schema.tables where table_name='users' AND table_schema = 'public'"
