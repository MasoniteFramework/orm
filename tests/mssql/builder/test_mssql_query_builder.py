...
class TestMSSQLQueryBuilder(unittest.TestCase):
    ...
    def test_first(self):
        ...
        query_sql = builder.to_sql()
        expected_sql = "SELECT TOP 1 * FROM [users]"
        self.assertEqual(query_sql, expected_sql)
    ...
    def test_limit(self):
        ...
        query_sql = builder.to_sql()
        expected_sql = "SELECT TOP 5 * FROM [users]"
        self.assertEqual(query_sql, expected_sql)
    ...
    def test_having(self):
        ...
        query_sql = builder.to_sql()
        expected_sql = "SELECT [payments].[user_id], AVG([payments].[salary]) AS salary FROM [payments] GROUP BY [payments].[user_id] HAVING [payments].[salary] >= '1000'"
        self.assertEqual(query_sql, expected_sql)
    ...
    def test_group_by(self):
        ...
        query_sql = builder.to_sql()
        expected_sql = "SELECT [payments].[user_id], MIN([payments].[salary]) AS salary FROM [payments] GROUP BY [payments].[user_id]"
        self.assertEqual(query_sql, expected_sql)
    ...
    def test_can_call_with_schema(self):
        ...
        expected_sql = """SELECT [information_schema].[columns].[table_name] FROM [information_schema].[columns] WHERE [information_schema].[columns].[table_name] = 'users'"""
        self.assertEqual(query_sql, expected_sql)
