...
setup(
    ...
    packages=[
        'masoniteorm.orm',
        'masoniteorm.orm.blueprint',
        'masoniteorm.orm.builder',
        'masoniteorm.orm.collection',
        'masoniteorm.orm.commands',
        'masoniteorm.orm.connections',
        'masoniteorm.orm.expressions',
        'masoniteorm.orm.factories',
        'masoniteorm.orm.grammar',
        'masoniteorm.orm.migrations',
        'masoniteorm.orm.models',
        'masoniteorm.orm.relationships',
        'masoniteorm.orm.schema',
        'masoniteorm.orm.scopes',
        'masoniteorm.orm.seeds',
        'masoniteorm.orm.testing',
    ],
